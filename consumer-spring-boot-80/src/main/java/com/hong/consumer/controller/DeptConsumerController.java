...
import com.hong.consumer.util.RandomAccessUtil;
...
public class DeptConsumerController {
    ...
    @Autowired
    public DeptConsumerController (RestTemplate restTemplate, RandomAccessUtil randomAccessUtil) {
    ...
    public Object addDept (DeptDTO deptDTO) {
        ...
        return this.restTemplate.postForObject(targetUri, deptDTO, Boolean.class);
    }
    ...
    public Object get (Long deptNo) {
        ...
        return this.restTemplate.getForObject(targetUri + deptNo, DeptDTO.class);
    }
    ...
    public Object list () {
        ...
        return this.restTemplate.postForObject(targetUri, null, List.class);
    }
    ...
    public Object split (int number, int limit, String column, String keyword) {
        ...
        return this.restTemplate.postForObject(targetUri + "?number=" + number + "&limit=" + limit + "&column=" + column + "&keyword=" + keyword, null, Map.class);
    }
